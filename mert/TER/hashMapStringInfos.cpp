...
int hashMapStringInfos::trouve(long searchKey) {
  ...
  for(vector<stringInfosHasher>::iterator l_hasher = m_hasher.begin(); l_hasher != m_hasher.end();
      l_hasher++) {
...
//
// //       vector<stringInfosHasher>::const_iterator l_hasher=m_hasher.begin();
//       for ( vector<stringInfosHasher>:: iterator l_hasher=m_hasher.begin() ;
//       l_hasher!=m_hasher.end() ; l_hasher++ )
//       {
...
string hashMapStringInfos::toString() {
  ...
  for(vector<stringInfosHasher>::iterator l_hasher = m_hasher.begin(); l_hasher != m_hasher.end();
    ...
    //         cout << ( *l_hasher ).getHashKey() <<" | "<< ( *l_hasher ).getKey() << " | " << (
    //         *l_hasher ).getValue() << endl;
  }
