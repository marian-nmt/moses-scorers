...
vector<ScoreStatsType> CapMicroOverlapping::prepareStats(const sentence_t& cand,
                                                         const sentence_t& ref) {
  vector<ScoreStatsType> stats(2);
  sentence_t intersection;

  set_intersection(cand.begin(),
                   cand.end(),
                   ref.begin(),
                   ref.end(),
...
vector<ScoreStatsType> CapMacroOverlapping::prepareStats(const sentence_t& cand,
                                                         const sentence_t& ref) {
