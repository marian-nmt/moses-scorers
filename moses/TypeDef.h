...
//#ifdef PT_UG
// setting to std::numeric_limits<size_t>::max() makes the regression test for (deprecated)
// PhraseDictionaryDynamicSuffixArray fail. const size_t DEFAULT_MAX_PHRASE_LENGTH = 100000;
//#else
