...
template <class T, class Closer>
class scoped : public scoped_base<T, Closer> {
public:
...
// Hat tip to boost.
template <class T>
class scoped_array : public scoped<T, scoped_delete_array_forward> {
public:
  ...
  const T &operator[](std::size_t idx) const {
    return scoped<T, scoped_delete_array_forward>::p_[idx];
  }
};
...
template <class T>
class scoped_ptr : public scoped<T, scoped_delete_forward> {
public:
